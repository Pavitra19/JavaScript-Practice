...
// Runtime: 64 ms (faster than 99.72%), Memory Usage: 38.2 MB (less than 94.55%)
var lengthOfLastWord = function (s) {
  return s.trim().length - s.trim().lastIndexOf(" ") - 1; // subtract first and last index of the last word
};
